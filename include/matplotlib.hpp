...
/**
 * Notice is hereby given that this file was sourced from the following repository:
 * https://github.com/lava/matplotlib-cpp under the MIT License. 
 * 
 * Huge credit to the author, whose name I do not know but to whom I am deeply
 * thankful.
 */
